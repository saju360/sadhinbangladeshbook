...
public class Nine_ordhay extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (activity !=null){
            ...
            activity.getSupportActionBar().setTitle("নবম অধ্যায়");
        }
        ...
        sharedPreferences = getActivity().getSharedPreferences("nine", MODE_PRIVATE);
        ...
        pdfView.fromAsset("9th_ordhay.pdf")
