...
public class Ten_ordhay extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (activity != null) {
            ...
            activity.getSupportActionBar().setTitle("দশম অধ্যায়");
        }
        ...
        sharedPreferences = getActivity().getSharedPreferences("ten", MODE_PRIVATE);
        ...
        pdfView.fromAsset("10th_ordhay.pdf")
