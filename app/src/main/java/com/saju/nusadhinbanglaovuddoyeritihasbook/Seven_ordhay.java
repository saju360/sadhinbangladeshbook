...
public class Seven_ordhay extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (activity != null) {
            ...
            activity.getSupportActionBar().setTitle("সপ্তম অধ্যায়");
        }
        ...
        sharedPreferences = getActivity().getSharedPreferences("seven", MODE_PRIVATE);
        ...
        pdfView.fromAsset("7th_ordhay.pdf")
