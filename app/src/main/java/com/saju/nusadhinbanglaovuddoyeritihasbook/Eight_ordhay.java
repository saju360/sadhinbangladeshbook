...
public class Eight_ordhay extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (activity != null) {
            ...
            activity.getSupportActionBar().setTitle("অষ্টম অধ্যায়");
        }
        ...
        sharedPreferences = getActivity().getSharedPreferences("eight", MODE_PRIVATE);
        ...
        pdfView.fromAsset("8th_ordhay.pdf")
