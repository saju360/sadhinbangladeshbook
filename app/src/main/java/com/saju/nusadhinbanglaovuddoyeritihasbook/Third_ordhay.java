...
public class Third_ordhay extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (activity !=null){
            ...
            activity.getSupportActionBar().setTitle("তৃতীয় অধ্যায়");
        }
        ...
        sharedPreferences = getActivity().getSharedPreferences("third", MODE_PRIVATE);
        ...
        pdfView.fromAsset("3rd_ordhay.pdf")
