...
public class Six_ordhay extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (activity != null) {
            ...
            activity.getSupportActionBar().setTitle("ষষ্ঠ অধ্যায়");
        }
        ...
        sharedPreferences = getActivity().getSharedPreferences("six", MODE_PRIVATE);
        ...
        pdfView.fromAsset("6th_ordhay.pdf")
