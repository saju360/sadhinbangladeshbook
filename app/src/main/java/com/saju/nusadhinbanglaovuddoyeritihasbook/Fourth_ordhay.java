...
public class Fourth_ordhay extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (activity != null) {
            ...
            activity.getSupportActionBar().setTitle("চতুর্থ অধ্যায়");
        }
        ...
        sharedPreferences = getActivity().getSharedPreferences("four", MODE_PRIVATE);
        ...
        pdfView.fromAsset("4th_ordhay.pdf")
